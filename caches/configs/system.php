...
'cookie_pre' => 'yqCXa_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://php.local/dream/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://php.local/dream/statics/js/', //CDN JS
'css_path' => 'http://php.local/dream/statics/css/', //CDN CSS
'img_path' => 'http://php.local/dream/statics/images/', //CDN img
'app_path' => 'http://php.local/dream/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'x6hhT7auZaudO9u048cc', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://php.local/dream/phpsso_server',	//接口地址
'phpsso_auth_key' => 'WqHe5FkGdBNUWIlafEcYwK8OlwanTNzN', //加密密钥
